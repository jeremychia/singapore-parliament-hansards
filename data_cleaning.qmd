...
replace_df <- 
  data.frame(old = c("Edwin Tong Chun Fai", "Josephine", "Muhamad Faisal bin Abdul Manap", "Pritam"),
             new = c("Edwin Tong", "Josephine Teo", "Muhamad Faisal Bin Abdul Manap", "Pritam Singh"))
